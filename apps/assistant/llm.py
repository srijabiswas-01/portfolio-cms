...
def generate_answer(question, documents, history):
    ...
    system_prompt = (
        ...
        "Keep the answer concise and recruiter-friendly, usually under 120 words. "
        "For substantive answers, start with a short Markdown level-three title, then a blank line "
        "and 2-5 short bullet points. Bold only the key label in each bullet. "
        "Use optional level-four section headings only when needed. Use standard Markdown with "
        "a space after each bullet marker and blank lines between blocks. Avoid tables, repeated "
        "summaries, and introductory filler. Keep simple greetings and unsupported answers as plain text. "
