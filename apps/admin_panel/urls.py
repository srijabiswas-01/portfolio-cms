...
urlpatterns = [
    ...
    path('blogs/', views.blogs_list, name='admin_blogs_list'),
    path('blogs/new/', views.blog_editor, name='admin_blog_editor'),
    path('blogs/<str:id>/toggle-active/', views.blog_toggle_active, name='admin_blog_toggle_active'),
    ...
    path('blog-categories/<str:id>/toggle-active/', views.blog_category_toggle_active, name='admin_blog_category_toggle_active'),
    path('blog-categories/<str:id>/delete/', views.blog_category_delete, name='admin_blog_category_delete'),
